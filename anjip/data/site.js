/* 안집 사이트 — 내용 전부의 기본값 (한 곳). 한옥반점 사이트(../hanok/data/site.js)와 같은 방식입니다.
   ...
   ★ 아직 확인 못 한 값(09-20 고모 답 뒤에도 남은 것): 전화번호 · 콜키지 금액 · 좌석 수 · 사업자번호(더미) · 지도 링크(더미). 아래 "확인" 표시. */
window.SITE_DEFAULT = {
  info: {
    name: "안집", tagline: "토속음식의 명가",
    addr: "경기 성남시 분당구 새마을로51번길 3 (서현동 136-12)", addr2: "경기 성남시 분당구\n새마을로51번길 3", zip: "13572",
    tel: "031-000-0000",   /* 확인 — 아직 못 받음 */
    parking: "발렛 포함 주차 1,000원", since: 1996,   /* 2019년에 "23년" 이라 홍보 → 1996년 개업 → 2026년 30년 */
    naverMap: "https://map.naver.com/", kakaoMap: "https://map.kakao.com/",   /* 더미(재아 09-20) — 실제 가게 링크로 바꿀 것 */
    instagram: "",
    owner: "김대용", bizno: "000-00-00000",   /* 사업자번호는 더미(재아 09-20) */
    services: ["예약 · 포장 · 단체 가능", "콜키지 가능 (유료)", "365일 연중무휴"],   /* 콜키지 금액 확인 */
    menuPdf: "menu.pdf",   /* 메뉴판 PDF — 재아가 만들어 anjip/menu.pdf 로 넣음(가격은 PDF 에만, 화면엔 없음 — 고모 09-20) */
    showPrices: false
  },

  /* 영업시간 — 고모 답(09-20): 11:30~21:50, 라스트오더 50분 전, 주말·공휴일은 21:20 까지. 브레이크 없음. 365일 연중무휴 */
  hours: [
    { day: "월 – 금", open: "11:30 – 21:50" },
    { day: "토 · 일 · 공휴일", open: "11:30 – 21:20" }
  ],
  hoursNote: ["라스트오더 영업종료 50분 전", "365일 연중무휴"],
  ...
  halls: [
    { name: "1층", cap: "", img: "hansang.jpg" },   /* 좌석 수 확인 · 매장 사진은 나중에(지금은 음식 사진으로 대신) */
    { name: "지하", cap: "", img: "crab-hands-wide.jpg" }
  ],

  home: {
    heroSlides: ["gejang.jpg", "crab-hands.jpg", "hansang.jpg"],
    heroTitle: "삼십 년, 한자리의 간장게장",
    heroSub: "경기 성남시 분당구 새마을로51번길 3 · 365일 연중무휴",
    intro: {
  ...
  menuPage: {
    head: { img: "gejang.jpg", title: "차림", sub: "게장 정식은 반드시 인원수에 맞게 주문해 주세요. 한우 구이와 게장 정식을 합쳐 인원수에 맞춰 주문하셔도 됩니다. 가격은 메뉴판 PDF 에서 보실 수 있습니다." },
    pdfLabel: "메뉴판 PDF",
    notes: [
  ...
  /* ---------- 차림 — 2026-09 메뉴판 사진에서 옮김. 가격(원)은 남겨 두되 화면엔 안 씀(info.showPrices) — PDF 만들 때 참고 ---------- */
  menu: [
    ...
    { id: "beef", title: "한우", sub: "숙성하지 않은 생고기 · 1++",
      ...
      note: "고기 추천을 원하시면 말씀해 주세요." },   /* 100g 단가는 가격이라 PDF 에만 */
