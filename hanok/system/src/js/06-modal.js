...
function renderStore(){
  ...
  const pageTitle = pageForm ? ({naver:"네이버 예약 가져오기", site:"홈페이지 관리", staff:"직원 근태", guests:"손님 관리"}[view.form.type] || "빠른 입력") : "";
        ...
        <div class="bar-right">
          ...
          <div class="more-wrap">
            ...
            <div class="more-menu">
              ...
              <button onclick="closeMore(); openStaffPage()">${ICON.staff}<span>직원 근태</span></button>
