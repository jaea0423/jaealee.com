"""
한옥반점 예약 시스템 — 빌드 스크립트 (v3 전용)

  결과물은 v3 폴더 안에만 만들어집니다. 원본(상위 폴더)은 절대 건드리지 않습니다.
...
# v3 는 이미지(assets)를 원본과 함께 씁니다 — 1.1MB 를 복사해 두면 나중에 갈라집니다.
...
def main():
    ...
    # 손님용 TV 화면은 screen/ 폴더로 엽니다 (jaealee.com/test/hanok/v4/screen/).
